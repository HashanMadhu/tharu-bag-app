...
class _AdminOrdersPageState extends ConsumerState<AdminOrdersPage> {
  // 🎯 ෆිල්ටර් සඳහා State variables
  String _selectedStatusFilter =
      'All'; // 'All', 'Pending', 'Processing', 'Delivered'
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: ['All', 'Pending', 'Processing', 'Delivered']
                            .map(
                    ...
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        _selectedDateFilter == null
                            ? "දිනය තෝරන්න"
                            : "${_selectedDateFilter!.year}-${_selectedDateFilter!.month.toString().padLeft(2, '0')}-${_selectedDateFilter!.day.toString().padLeft(2, '0')}",
                    ...
                    // Clear Date Filter Button (දිනය අයින් කරන්න)
              ...
              Expanded(
                child: ordersAsync.when(
                  data: (orders) {
                    // ⚙️ Client-side filtering logic
                    final filteredOrders = orders.where((order) {
                      // 1. Status Filter එක බැලීම
                      final String currentStatus = order['status'] ?? 'Pending';
                      bool matchesStatus =
                      ...
                      // 2. Date Filter එක බැලීම
                      bool matchesDate = true;
                      final Timestamp? timestamp =
                          order['orderDate'] as Timestamp?;
                      if (_selectedDateFilter != null && timestamp != null) {
                        final orderDate = timestamp.toDate();
                        // වර්ෂය, මාසය සහ දිනය සමානදැයි පමණක් බලයි
                        matchesDate =
                            orderDate.year == _selectedDateFilter!.year &&
                            orderDate.month == _selectedDateFilter!.month &&
                            orderDate.day == _selectedDateFilter!.day;
                      }
                    ...
                    if (filteredOrders.isEmpty) {
                      return const Center(
                        child: Text(
                          "තෝරාගත් ෆිල්ටරයට අනුව ඇණවුම් කිසිවක් නැත.",
                        ),
                      );
                    }
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(16.0),
                            key: ValueKey(orderId), // ListView Performance සඳහා
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Row(
